...
input_images = r'G:\.shortcut-targets-by-id\12Hx4b2g2wKsJH5QS1Ai4UlvJ7QS32sjy\Bhawana_Acharya\2024_Projects\Images\Data\Processed\Soy1'
output_images = r"G:\.shortcut-targets-by-id\12Hx4b2g2wKsJH5QS1Ai4UlvJ7QS32sjy\Bhawana_Acharya\2024_Projects\Images\Data\Processed\Soy1_Counted"
...
erode_width = 10  # Adjusted to more realistic values
dilate_width = 60  # Adjusted to more realistic values

#%%=======================  Format: [lower_bound, upper_bound], where each bound is a 3-element list [R, G, B]
soybean_range = [[66, 102, 64], [118, 152, 101]]  # Adjust these values based on your soybean color
...
resultsdf.to_csv((r'G:\.shortcut-targets-by-id\12Hx4b2g2wKsJH5QS1Ai4UlvJ7QS32sjy\Bhawana_Acharya\2024_Projects\Images\Results\Pixel_Blob_Counts.csv'), index=False)
